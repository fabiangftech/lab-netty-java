...
public class InternalRouter {
    ...
    public record Match(HttpMethod method, Handler handler, Map<String, String> pathParams) {
    ...
    private static final class Node {
        ...
        private final Map<HttpMethod, Handler> handlersByMethod = new HashMap<>();
    ...
    public void add(HttpMethod method, String path, Handler handler, int priority) {
        if (method == null) {
        ...
        Handler existing = node.handlersByMethod.get(method);
    ...
    public Match match(HttpMethod method, String path) {
        ...
        while (true) {
            ...
            if (child != null) {
                ...
                Handler handler = node.wildcardChild.handlersByMethod.get(method);
                if (handler != null) {
                    return new Match(method, handler, params);
                }
                return null;
